...
from xml.sax.handler import (
    _ContentHandlerProtocol,
    _DTDHandlerProtocol,
    _EntityResolverProtocol,
    _ErrorHandlerProtocol,
)
...
class AttributesImpl(Generic[_AttrKey]):
    ...
    @overload
    def get(self, name: _AttrKey, alternative: None = ...) -> str | None: ...
    @overload
...
class AttributesNSImpl(AttributesImpl[_NSName]):
    ...
    @overload
    def get(self, name: _NSName, alternative: None = ...) -> str | None: ...
    @overload
