...
class DOMBuilder:
    ...
    errorHandler: _DOMErrorHandler | None
    filter: DOMBuilderFilter | None
    ACTION_REPLACE: Final = ...
    ACTION_APPEND_AS_CHILDREN: Final = ...
    ACTION_INSERT_AFTER: Final = ...
    ACTION_INSERT_BEFORE: Final = ...
    ...
    def parseWithContext(
        self, input: DOMInputSource, cnode: Node, action: Literal[1, 2, 3, 4]
    ) -> NoReturn: ...
...
class DOMImplementationLS:
    MODE_SYNCHRONOUS: Final = ...
    MODE_ASYNCHRONOUS: Final = ...
